...
const initApp = () => {
  console.log("Main App: Init starting... Checking globals:");
  console.log("TOURS:", window.TOURS ? "OK" : "MISSING");
  console.log("REVIEWS:", window.REVIEWS ? "OK" : "MISSING");
  try {
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            entry.target.classList.add("is-revealed"); // Sync with style.css
    ...
    document.body.addEventListener("click", (e) => {
      ...
      if (target.closest(".transport-label") || target.closest(".transport-checkbox")) {
         e.stopPropagation();
         return;
      }
